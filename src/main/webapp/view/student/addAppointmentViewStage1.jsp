        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 p-5" style="border-radius: 10px; border:solid #2e9ba3 2px;">
                    ...
                    <h4>Select a consultant and make an appointment</h4>
                    <ul><%
                        List<Consultant> consultantList = (List<Consultant>) request.getAttribute("consultantList");
                        for(Consultant consultant : consultantList){
                            %>
                                <li> <a href="http://localhost:9096/student/appointment/stage2/<%=consultant.getId() %>"><%=consultant.getUsername() %></a> </li>
                            <%
                        }
                    %></ul>
                </div>
