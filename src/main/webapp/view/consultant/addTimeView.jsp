            ...
            <div class="row">
                <div class="col-md-12 p-5 text-center" style="border-radius: 10px; border:solid #2e9ba3 2px;">
                    <div class="text-center">
                        <h3>Add your available time</h3>
                    </div>
                    <form action="http://localhost:9096/consultant/addtime" method="post" class="my-2 my-lg-0" onSubmit="return validate()">
                        <%
                        ...
                        <br/>
                        <button class="btn btn-outline-info my-2 my-sm-0" type="submit">Add Time</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 p-5 text-center" style="border-radius: 10px; border:solid #2e9ba3 2px;">
                        ...
                        <ul><%
                            List<Consulttime> consulttimeListView = (List<Consulttime>) request.getAttribute("consulttimeListView");
