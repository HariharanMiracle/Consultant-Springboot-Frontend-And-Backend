...
<% Template template = Template.getObject(); %>
        ...
        <div class="container">
            ...
            <div class="ml-5">
                <ul>
                    <li><a href = "http://localhost:9096/consultant/details">Details</a></li>
                    <li><a href = "http://localhost:9096/consultant/update">Update</a></li>
                    <li><button onclick="deleteFunction()" class="btn btn-link">Delete</button></li>
                    <li><a href = "http://localhost:9096/consultant/addtime">Add Time</a></li>
                    <li><a href = "http://localhost:9096/consultant/appointment/myappointment">View My Appointments</a></li>
                </ul>
            </div>
        </div>
</body>
...
<script>
    function deleteFunction() {
      ...
      if (r == true) {
        window.location.href = "http://localhost:9096/consultant/delete";
      }
    }
</script>
